...
export const PrivacyPolicyPage: React.FC = () => (
  <div className="section-padding">
    <div className="container" style={{ maxWidth: '800px' }}>
      ...
      <h1 style={{ fontSize: '2.5rem', fontWeight: 800, color: '#1C2677', marginTop: '8px', marginBottom: '24px' }}>
        Privacy Policy
      </h1>
      <div className="glass-card" style={{ padding: '36px', lineHeight: 1.8, color: '#334155' }}>
        ...
        <h3 style={{ color: '#1C2677', marginTop: '20px' }}>1. Information We Collect</h3>
        ...
        <h3 style={{ color: '#1C2677', marginTop: '20px' }}>2. Data Security & Storage</h3>
  ...
  <div className="section-padding">
    <div className="container" style={{ maxWidth: '800px' }}>
      ...
      <div className="glass-card" style={{ padding: '36px', lineHeight: 1.8, color: '#334155' }}>
        ...
        <h3 style={{ color: '#1C2677', marginTop: '20px' }}>1. Service Scope & Inspection</h3>
        ...
        <h3 style={{ color: '#1C2677', marginTop: '20px' }}>2. Customer Property Preparation</h3>
...
export const RefundPolicyPage: React.FC = () => (
  <div className="section-padding">
    <div className="container" style={{ maxWidth: '800px' }}>
      ...
      <div className="glass-card" style={{ padding: '36px', lineHeight: 1.8, color: '#334155' }}>
        <p><strong>Last Updated: August 1, 2026</strong></p>
        <div style={{ background: 'rgba(41, 195, 190, 0.12)', padding: '16px', borderRadius: '14px', marginBottom: '20px', border: '1px solid #29C3BE', fontWeight: 600, color: '#1C2677' }}>
          🛡️ {REFUNDABLE_DEPOSIT_NOTICE}
        </div>

        <h3 style={{ color: '#1C2677', marginTop: '20px' }}>1. Booking Deposit Refundability</h3>
        ...
        <h3 style={{ color: '#1C2677', marginTop: '20px' }}>2. Quality Satisfaction Guarantee</h3>
  ...
  <div className="section-padding">
    <div className="container" style={{ maxWidth: '800px' }}>
      ...
      <div className="glass-card" style={{ padding: '36px', lineHeight: 1.8, color: '#334155' }}>
        ...
        <h3 style={{ color: '#1C2677', marginTop: '20px' }}>1. Free Cancellation Window</h3>
        <p>You may cancel or reschedule your booking free of cost up to 4 hours prior to your scheduled time slot.</p>

        <h3 style={{ color: '#1C2677', marginTop: '20px' }}>2. Late Cancellation</h3>
