      ...
      >
        ...
        <div
          style={{
            ...
            height: '600px',
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(155, 200, 59, 0.22) 0%, rgba(0, 122, 135, 0.18) 50%, rgba(3, 37, 42, 0) 70%)',
            filter: 'blur(90px)',
            pointerEvents: 'none',
            zIndex: 0
          }}
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, width: '100%' }}>
          ...
          <div
            ...
            style={{
              ...
              borderRadius: '24px',
              overflow: 'hidden',
              boxShadow: '0 25px 60px rgba(0, 0, 0, 0.6), 0 0 35px rgba(0, 122, 135, 0.25)',
          ...
          >
            ...
            <motion.div
              style={{
                ...
                width: '3px',
                background: '#9BC83B',
                boxShadow: '0 0 15px #9BC83B, 0 0 35px #9BC83B',
                zIndex: 10,
                pointerEvents: 'none',
                willChange: 'left'
              }}
              ...
              {isMobile && (
                <div
                  style={{
                    ...
                    boxShadow: '0 4px 15px rgba(0, 0, 0, 0.5), 0 0 20px rgba(155, 200, 59, 0.9)',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    gap: '2px',
